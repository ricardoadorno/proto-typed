...
function getViewCompletions(): vscode.CompletionItem[] {
  const screen = new vscode.CompletionItem(
    'screen',
  ...
  const modal = new vscode.CompletionItem(
    'modal',
    vscode.CompletionItemKind.Keyword
  )
  ...
  const drawer = new vscode.CompletionItem(
    'drawer',
    vscode.CompletionItemKind.Keyword
  )
...
function getComponentCompletions(): vscode.CompletionItem[] {
  const component = new vscode.CompletionItem(
    'component',
    vscode.CompletionItemKind.Class
  )
  component.insertText = new vscode.SnippetString(
...
function getComponentInstanceCompletions(): vscode.CompletionItem[] {
  const instance = new vscode.CompletionItem(
    '$Component',
...
function getComponentPropCompletions(): vscode.CompletionItem[] {
  const prop = new vscode.CompletionItem(
    '%propName',
...
function getTypographyCompletions(): vscode.CompletionItem[] {
  ...
  for (let i = 1; i <= 4; i++) {
    ...
    heading.insertText = new vscode.SnippetString(
      `${'#'.repeat(i)} \${1:Heading Text}`
    )
  ...
  // Paragraph (body text)
  const paragraph = new vscode.CompletionItem(
    'paragraph',
    vscode.CompletionItemKind.Text
  )
  ...
  // Small text
  const small = new vscode.CompletionItem(
    'small',
    vscode.CompletionItemKind.Text
  )
  ...
  // Muted text
  const muted = new vscode.CompletionItem(
    'muted',
    vscode.CompletionItemKind.Text
  )
  ...
  // Blockquote
  const blockquote = new vscode.CompletionItem(
    'blockquote',
    vscode.CompletionItemKind.Text
  )
...
function getButtonCompletions(): vscode.CompletionItem[] {
  ...
  // Button with icon
  const withIcon = new vscode.CompletionItem(
    'button-with-icon',
    vscode.CompletionItemKind.Function
  )
  withIcon.insertText = new vscode.SnippetString(
    '@[${1:Button Text}]{${2:icon}}(${3:action})'
  )
...
function getLinkCompletions(): vscode.CompletionItem[] {
  ...
  link.insertText = new vscode.SnippetString(
    '> [${1:Link Text}](${2:destination})'
  )
  ...
  const image = new vscode.CompletionItem(
    'image',
    vscode.CompletionItemKind.File
  )
  image.insertText = new vscode.SnippetString('![${1:Alt Text}](${2:url})')
  image.documentation = new vscode.MarkdownString('**Image**\n\n`![Alt](url)`')
  image.sortText = '40-image'

  const roundedImage = new vscode.CompletionItem(
    'image-rounded',
    vscode.CompletionItemKind.File
  )
  roundedImage.insertText = new vscode.SnippetString(
    '!rounded[${1:Alt Text}](${2:url})'
  )
  ...
  const circleImage = new vscode.CompletionItem(
    'image-circle',
    vscode.CompletionItemKind.File
  )
  circleImage.insertText = new vscode.SnippetString(
    '!circle-${1:64}x${2:64}[${3:Avatar}](${4:url})'
  )
...
function getFormCompletions(): vscode.CompletionItem[] {
  ...
  const input = new vscode.CompletionItem(
    'input',
    vscode.CompletionItemKind.Field
  )
  input.insertText = new vscode.SnippetString(
    '___[${1:Label}][${2:Placeholder}]'
  )
  ...
  const password = new vscode.CompletionItem(
    'password',
    vscode.CompletionItemKind.Field
  )
  password.insertText = new vscode.SnippetString(
    '___password[${1:Password}][${2:Enter password}]'
  )
  ...
  const select = new vscode.CompletionItem(
    'select',
    vscode.CompletionItemKind.Field
  )
  ...
  const checkbox = new vscode.CompletionItem(
    'checkbox',
    vscode.CompletionItemKind.Field
  )
...
function getStructureCompletions(): vscode.CompletionItem[] {
  ...
  const list = new vscode.CompletionItem(
    'list',
    vscode.CompletionItemKind.Module
  )
  list.insertText = new vscode.SnippetString(
    'list:\n\t- ${1:Item 1}\n\t- ${2:Item 2}$0'
  )
  ...
  const navigator = new vscode.CompletionItem(
    'navigator',
    vscode.CompletionItemKind.Module
  )
...
function getStylesCompletions(): vscode.CompletionItem[] {
  const styles = new vscode.CompletionItem(
    'styles',
    vscode.CompletionItemKind.Module
  )
  styles.insertText = new vscode.SnippetString(
