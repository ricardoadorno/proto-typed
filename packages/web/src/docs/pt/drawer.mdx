...
## Exemplo básico
<DocsCodePreview title="Drawer de filtros em dashboard">
```dsl
drawer FilterDrawer:
  container:
    # Filtros avançados
...
## Variantes
<DocsCodePreview title="Drawer com stack para configurações">
```dsl
...
<DocsCodePreview title="Drawer com lista resumida">
```dsl
...
<DocsCodePreview title="Drawer com formulário contextual">
```dsl
drawer NoteDrawer:
  container:
    # Adicionar nota
...
<DocsCodePreview title="Tela com drawer de detalhes">
```dsl
screen Accounts:
  container-wide:
    # Contas ativas
...
<DoDont
  dont={{
    title: "Lista com links navegáveis",
    code: `
drawer MainMenu:
  
    - @link[Dashboard](Dashboard)
    - @link[Relatórios](Reports)
    `,
  }}
  do={{
...
<DocsCodePreview title="Fluxo drawer + modal">
```dsl
